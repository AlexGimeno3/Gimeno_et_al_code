...
def main_IBI(x, Fs, feat_name):
    ...
    bdetect_path = Path(r"E:\EEG_Pipeline_Continuous\99_extract_all_variables\py_burst_detector-master")
    bdetect_path_exist = os.path.isfile(bdetect_path / "burst_detector" / "eeg_burst_detector.py")
